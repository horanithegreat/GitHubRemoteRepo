...
public class PersonDao {
    ...
    /**
     * This function is used to convert a 'Model' object created using slim3 framework
    ...
    public void insertPerson(PersonModel inputPerson) {
        ...
        Transaction trans = this.dataService.beginTransaction();
        /*TODO: Insert the entity to the datastore.*/
        this.dataService.put(this.modelToEntity(inputPerson));
